...
/*
  -Português:
  Classe responsavel por validação de CPF (Cadastro de Pessoa Fisíca) e
   funções semelhantes e afins.

  -English:
  
Class responsible for validating CPF (Individual Taxpayer Registration) 
and similar and related functions.
*/
